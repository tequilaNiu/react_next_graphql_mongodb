...
var _jsxFileName = "/Users/admaster/Workspace/next-demo/pages/post.js";
...
function (_React$Component) {
  ...
  function Post() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = Post.__proto__ || Object.getPrototypeOf(Post)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "myClick", {
      configurable: true,
      enumerable: true,
      writable: true,
  ...
  _createClass(Post, [{
    ...
    value: function render() {
      ...
      }, this.props.url.query.id), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("p", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 43
        }
      }, "This is the blog post content."), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("p", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 44
        }
      }, "\u8BA1\u6570\u5668\uFF1A ", this.props.index), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("button", {
        onClick: this.myClick,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 45
        }
      }, "\u70B9\u6211"), this.state.userName);
    }
  }, {
        ...
        return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                query = _ref2.query;
                console.log('>>>>>>>>>>>>>'); // const res = await axios('https://api.tvmaze.com/search/shows?q=batman')
                // const data = res.data
...
(function () {
  ...
  reactHotLoader.register(Post, "Post", "/Users/admaster/Workspace/next-demo/pages/post.js");
  leaveModule(module);
})();
...
//# sourceMappingURL=4.9eff4a4f44acec165d4c.hot-update.js.map